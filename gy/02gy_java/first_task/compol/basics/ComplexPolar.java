...
public class ComplexPolar
{
  ...
  } // a komplex szám valós részének kiszámítása
  public double im()
  {
    return r * Math.sin(theta);
  } // a komplex szám képzetes részének kiszámítása
  ...
  {
    return a.toPolar(Math.pow(a.r, n) * Math.cos(n * a.theta),
        Math.pow(a.r, n) * Math.sin(n * a.theta));
  }
