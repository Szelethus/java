...
public class Finder{
	...
	public boolean findText(String textToFind, String filePath) throws FileNotFoundException, IOException
	{
		File f = new File(filePath);
	...
	public boolean findText(String textToFind, File f) throws FileNotFoundException, IOException
	{
		//File f  = new File(filePath);
		if(f.isDirectory())
		{
